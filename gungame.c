...
void info()
{
	...
	setcolor(8);
	outtextxy(360, 150, "  Senthilnathan A ");
	outtextxy(360, 160, "  IInd year B.tech, CSE ");
	outtextxy(360, 170, "  Sri Manakula Vinayagar ");
	outtextxy(360, 180, "  Engineering College ");
	outtextxy(360, 190, "  Puducherry  ");
	setcolor(0);
	outtextxy(360, 210, "Email :  ");
	setcolor(8);
	outtextxy(360, 230, "meetsenthilnathan@gmail.com ");
	setcolor(0);
	outtextxy(360, 250, "Date :  ");
	setcolor(8);
	outtextxy(410, 250, "  22/JUL/2007 ");
	setcolor(0);
	outtextxy(360, 270, "Language Used : ");
	setcolor(8);
	outtextxy(490, 270, "  C ");
}
